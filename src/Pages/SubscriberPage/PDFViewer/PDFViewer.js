...
const PDFViewer = () => {
    ...
    return (
        ...
        >
            ...
            <header className="pdf-viewer-header">
                ...
                <div className="header-right">
                    <div className="zoom-controls-compact">
                        ...
                        <button
                            className={`fit-width-btn ${isFitWidth ? 'active' : ''}`}
                            onClick={handleFitWidth}
                        >
                            {isFitWidth ? 'Actual' : 'Fit Width'}
                        </button>
                    </div>
            ...
            <div className="page-controls-compact">
                <button className="page-nav-btn" onClick={handlePreviousPage}>
                    ◀
                </button>
